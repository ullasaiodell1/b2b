...
export interface QuotationFilterComponentProps {
  referrer?: string;
  leadId?: string;
  qStartDate?: string;
  qEndDate?: string;
...
export const QuotationFilterComponent: React.FC<QuotationFilterComponentProps> = ({
  referrer,
  leadId,
  qStartDate,
  qEndDate,
...
const getStyles = (theme: any) => StyleSheet.create({
  ...
  dateResetText: { fontSize: 12, fontWeight: '800', color: COLORS.textDark },
  footer: {
    flexDirection: 'row',
    paddingHorizontal: 20,
    paddingTop: 12,
