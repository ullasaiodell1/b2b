...
export interface AddQuotationComponentProps {
...
export const AddQuotationComponent: React.FC<AddQuotationComponentProps> = ({
  initialLeadId,
  initialCompanyName,
  initialContactName,
  initialContactPhone,
  ...
  const handleQuickCreateLead = async () => {
    ...
    if (newLeadPhone.trim().length !== 10) {
  ...
  // ── Form state ─────────────────────────────────────────────────────────────
  const [quotationDate] = useState<Date>(new Date());
        ...
        >
          ...
          <View style={[styles.modalContent, { maxHeight: '80%', paddingBottom: 30 }]}>
            ...
            <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingVertical: 10, gap: 12 }} keyboardShouldPersistTaps="handled">
              <View style={styles.formField}>
                <Text style={styles.inputLabel}>Full Name <Text style={{ color: COLORS.danger }}>*</Text></Text>
                <TextInput
                  style={styles.textInputBox}
              ...
              <View style={styles.formField}>
                <Text style={styles.inputLabel}>Company Name <Text style={{ color: COLORS.danger }}>*</Text></Text>
                <TextInput
                  style={styles.textInputBox}
