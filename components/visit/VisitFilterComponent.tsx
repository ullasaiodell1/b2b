...
export interface VisitFilterComponentProps {
  isEmbedded?: boolean;
}

export function VisitFilterComponent({
  isEmbedded = false,
  ...
  const params = (route.params as { status?: string; company?: string; dateRange?: string; leadId?: string }) || {};
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.root}>
      ...
      {/* FOOTER BUTTONS */}
      <View style={[styles.footerContainer, { paddingBottom: isEmbedded ? 12 : Math.max(insets.bottom + 10, 16) }]}>
        <TouchableOpacity
